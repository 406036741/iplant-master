...
package com.iplant.libzxing.decode;
...
import com.iplant.R;
import com.iplant.libzxing.activity.QrCodeActivity;
...
final class DecodeHandler extends Handler {
    ...
    private void decode(byte[] data, int width, int height) {
        ...
        try {
            if(mCropRect==null)
                mCropRect = mActivity.getCropRect();

            PlanarYUVLuminanceSource source =
                new PlanarYUVLuminanceSource(mRotatedData, width, height, mCropRect.left, mCropRect.top, mCropRect.width(), mCropRect
                        .height(), false);
